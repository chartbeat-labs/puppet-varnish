...
describe 'varnish::instance', :type => :define do
  ...
  describe 'when installing a default varnish instance' do
    ...
    it { should contain_file('/etc/default/varnish-default') \
          ...
          .with_content(/-p between_bytes_timeout=60/) \
          .with_content(/-p cli_buffer=8192/) \
          .with_content(/-p cli_timeout=10/) \
          .with_content(/-p clock_skew=10/) \
          .with_content(/-p connect_timeout=0.7/) \
          ...
          .with_content(/-p first_byte_timeout=60/) \
          ...
          .with_content(/-p pipe_timeout=60/) \
          ...
          .with_content(/-p send_timeout=60/) \
          .with_content(/-p sess_timeout=5/) \
    ...
    it { should contain_file('/etc/varnish/main-default.vcl') \
          ...
          .with_content(/backend backend0.*host\ =\ "127\.0\.0\.1";.*port\ =\ "8080";.*first_byte_timeout\ =\ 60;/sm) \
